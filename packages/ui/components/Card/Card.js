...
var CardTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, _b = _a.as, Component = _b === void 0 ? "h3" : _b, props = __rest(_a, ["className", "as"]);
    return (_jsx(Component, __assign({ ref: ref, className: cn("text-2xl font-semibold leading-none tracking-tight", className) }, props)));
});
