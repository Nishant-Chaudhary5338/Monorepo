 ...
 */
export type FieldType = "text" | "email" | "password" | "number" | "textarea" | "select" | "checkbox" | "radio" | "date" | "switch";
/**
 ...
 */
export type FieldsConfig<T extends FieldValues> = Partial<Record<keyof T, FieldConfig>>;
/**
...
//# sourceMappingURL=AutoForm.types.d.ts.map