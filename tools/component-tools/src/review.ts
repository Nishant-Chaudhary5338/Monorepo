...
function calculateQualityScore(
  ...
  if (content.includes('forwardRef')) score += 5;
  if (content.includes('.displayName')) score += 5;
  if (content.includes('interface') && content.includes('Props')) score += 5;
  if (content.includes('cn(')) score += 3;
  if (content.includes('focus-visible')) score += 3;
  if (content.includes('disabled:pointer-events-none')) score += 2;
