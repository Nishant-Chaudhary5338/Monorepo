...
class ComponentFactoryServer extends McpServerBase {
    ...
    registerTools() {
        ...
        this.addTool('scaffold_component_folder', 'Create the folder structure for a component without generating code', {
            type: 'object',
            properties: {
        ...
        this.addTool('review_component', 'Review a generated component for TypeScript errors, test results, accessibility issues, and code quality', {
            type: 'object',
            properties: {
        ...
        this.addTool('generate_documentation', 'Generate documentation for a component including MDX docs, API JSON, and usage examples', {
            type: 'object',
            properties: {
        ...
        this.addTool('fix_improvise_review', 'Fix issues, add more variants/stories/tests, and review component quality. Use this for iterative improvement.', {
            type: 'object',
            properties: {
                path: { type: 'string', description: 'Path to the component directory' },
            },
