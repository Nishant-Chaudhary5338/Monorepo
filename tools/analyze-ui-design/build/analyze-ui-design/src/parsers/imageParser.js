 ...
 */
export async function parseImage(filePath, maxWidth = DEFAULT_MAX_WIDTH) {
 ...
 */
export async function parseImageBuffer(buffer, maxWidth = DEFAULT_MAX_WIDTH) {
 ...
 */
export async function extractRegion(image, x, y, width, height) {
 ...
 */
export async function getDominantColor(buffer) {
