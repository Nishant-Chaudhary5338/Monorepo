 ...
 */
export async function parsePdf(filePath, maxWidth = 1920) {
 ...
 */
export async function parsePdfBuffer(buffer, maxWidth = 1920) {
    ...
    try {
        ...
        try {
            ...
            throw new Error('pdfjs-dist is required for PDF parsing. Install it with: pnpm add pdfjs-dist');
        }
    }
 ...
 */
function createCanvasContext(pixelData, width, height) {
