 ...
 */
export function getToolsDir(startDir) {
 ...
 */
export function resolveFromRoot(relativePath, startDir) {
    const root = findWorkspaceRoot(startDir);
 ...
 */
export function resolveFromToolsDir(relativePath, startDir) {
 ...
 */
export function getToolDirectories(startDir) {
    const toolsDir = getToolsDir(startDir);
 ...
 */
export function isInsideToolsDir(targetPath, startDir) {
    const toolsDir = getToolsDir(startDir);
 ...
 */
export function getRelativeFromRoot(targetPath, startDir) {
    const root = findWorkspaceRoot(startDir);
