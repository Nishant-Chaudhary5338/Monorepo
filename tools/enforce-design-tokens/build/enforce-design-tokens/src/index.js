...
class EnforceDesignTokensServer extends McpServerBase {
    ...
    registerTools() {
        this.addTool('scan_tokens', 'Scan files for hardcoded design values (colors, spacing, font sizes, radii, shadows, z-index) that should use design tokens', {
            type: 'object',
            properties: {
        ...
        this.addTool('suggest_tokens', 'Suggest design-token replacements for each hardcoded value found', {
            type: 'object',
            properties: {
                path: { type: 'string', description: 'Path to file or directory to scan' },
            },
        ...
        this.addTool('enforce_tokens', 'Grade a path on design-token compliance and group violations by file', {
            type: 'object',
            properties: {
                path: { type: 'string', description: 'Path to file or directory to scan' },
            },
