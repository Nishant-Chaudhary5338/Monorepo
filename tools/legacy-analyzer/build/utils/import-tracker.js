...
import { findSourceFiles } from './file-scanner.js';
 ...
 */
export function resolveImportPath(fromFile, specifier, rootDir, allFiles) {
 ...
 */
export function findDeepImports(graph) {
    const deepImports = [];
 ...
 */
export function findCrossFeatureImports(graph, rootDir, srcDir = 'src') {
    const crossFeature = [];
 ...
 */
export function findUnusedImports(content, imports) {
    const unused = [];
    for (const imp of imports) {
 ...
 */
export function calculateCoupling(graph, fileA, fileB) {
