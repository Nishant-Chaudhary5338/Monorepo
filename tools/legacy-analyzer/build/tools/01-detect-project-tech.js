...
// ============================================================================
import { readPackageJson, hasConfigFile } from '../utils/file-scanner';
const MAJOR_DEPS = [
...
export async function detectProjectTech(appPath, config) {
    ...
    const language = (hasTypeScript || hasTSConfig) ? 'TypeScript' : 'JavaScript';
    // Detect CRA
    ...
    if (allDeps['next'])
        ...
        framework = 'CRA';
    else if (allDeps['vite'] || allDeps['@vitejs/plugin-react'])
        framework = 'Vite';
...
//# sourceMappingURL=01-detect-project-tech.js.map