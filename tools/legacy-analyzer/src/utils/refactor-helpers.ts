 ...
 */
export const FEATURE_SUBDIRS = ['components', 'hooks', 'api', 'pages', 'types', 'utils'] as const;

/**
 * Standard shared layer directories
 */
export const SHARED_DIRS = ['components', 'hooks', 'utils', 'types', 'lib', 'styles'] as const;

/**
 * Standard app-level directories
 */
export const APP_DIRS = ['router', 'store', 'providers'] as const;
