...
import type { AnalyzeRoutingOutput, AnalyzerConfig } from '../types';

const ROUTING_LIBRARIES = ['react-router-dom', 'react-router', '@reach/router', 'wouter', 'preact-router'] as const;
