...
export const expCards: ExpCard[] = [
  {
    ...
    highlights: [
      "Built an AI-driven development system using Monorepo architecture and custom MCP tools that automated 60-70% of repetitive frontend tasks",
      "Created a reusable headless UI framework for production-grade dashboards, reducing development time by ~60%",
      "Improved data fetching speed by 30% and reduced incident reporting time by 40% through strategic performance optimizations",
    ],
    responsibilities: [
  ...
  {
    review:
      "Nishant delivered a robust SAP web interface and implemented enterprise-grade SSO solutions. His e-commerce platform work serving 15,000+ B2B users demonstrated exceptional attention to scalability and user experience.",
    ...
    highlights: [
      "Implemented Azure AD SSO and Google SSO for 15,000+ B2B users",
      "Built SAP web interface integrating SAP Cloud Platform with React",
      "Optimized React apps reducing load times by 40%",
    ],
    responsibilities: [
      "Implemented Azure AD SSO (MSAL) and Google SSO (OAuth 2.0) for secure, seamless authentication and role-based access across enterprise applications",
      ...
      "Contributed to an e-commerce platform serving 15,000+ B2B users, implementing order tracking, bulk ordering, and Google Analytics integration for behavior insights",
      "Engineered a responsive LMS platform integrating video streaming, quiz modules, and interactive learning components",
      "Optimized React applications using pre-fetching, caching, lazy loading, and code splitting — reducing load times by 40%",
    ],
