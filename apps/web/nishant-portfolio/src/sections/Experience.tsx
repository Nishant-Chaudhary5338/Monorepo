                  ...
                  <div className="expText flex xl:gap-20 md:gap-10 gap-5 relative z-20">
                    ...
                    <div>
                      <h3
                        ...
                        style={{ fontSize: "clamp(1.6rem, 2.8vw, 2.2rem)", color: "var(--fg)" }}
                      >
                        {card.title}
                      </h3>
                      <div
                        className="mono-label mt-2"
                        style={{ fontSize: "0.84rem", color: "var(--accent)", textTransform: "none" }}
                      >
                        {card.company}
                      </div>
                      <div
                        className="mono-label mt-1"
                        style={{ color: "var(--fg-muted)", fontSize: "0.76rem" }}
                      >
                      ...
                      <div className="mt-7">
                        ...
                        <ul className="flex flex-col gap-3">
                          {card.highlights.map((highlight, i) => (
                            ...
                            >
                              <span style={{ color: "var(--highlight)", marginTop: "4px", flexShrink: 0 }}>▸</span>
                              <span>{highlight}</span>
                            </li>
                          ))}
                        </ul>
                      ...
                      <div className="mt-6">
                        <div className="mono-label mb-3" style={{ color: "var(--fg-muted)" }}>
                          Responsibilities
                        </div>
                        <ul className="flex flex-col gap-3">
                          {card.responsibilities.map((r, i) => (
                            <li
                              ...
                              style={{ color: "var(--fg-2)", lineHeight: 1.6 }}
                            >
                              <span style={{ color: "var(--border-strong)", marginTop: "4px", flexShrink: 0 }}>–</span>
                              <span>{r}</span>
                            </li>
                          ))}
                        </ul>
