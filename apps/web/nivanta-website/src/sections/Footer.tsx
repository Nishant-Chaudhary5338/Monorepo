      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-10 pt-16 pb-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="lg:col-span-1 flex flex-col items-start">
            ...
            <p className="text-xs leading-relaxed text-white/35 mb-5">
            ...
            <div className="flex gap-2">
              {socials.map((s) => (
                <a
                  ...
                  className="w-8 h-8 border border-white/15 flex items-center justify-center text-white/40 hover:border-gold hover:text-gold transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="text-xs text-white/45 hover:text-gold transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <address className="not-italic">
            ...
            <div className="space-y-3 text-xs text-white/45">
              ...
              <div className="space-y-1">
                <a href="tel:+919792106111" className="block hover:text-gold transition-colors">+91 979 210 6111</a>
                <a href="tel:+919792107111" className="block hover:text-gold transition-colors">+91 979 210 7111</a>
                <a href="tel:+919792109111" className="block hover:text-gold transition-colors">+91 979 210 9111</a>
              </div>
